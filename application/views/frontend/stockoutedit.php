...
<?php 
     ...
     <?php
			$attributes = array('name' => 'stockmaster', 'id' => 'stockmaster');	   
	  		echo form_open('stockmaster/editStockout', $attributes);
			echo form_hidden('id',$fid['value']);
			echo form_hidden('mAaterialName',$fmaterialId['value']);
...
<?php
 ...
 ?>
		...
		<td><div class="row-fluid" id="vehicleType"><label>Cost<span class="f_req">*</span></label>
                                           <?php $atts = array(
													  'name' => 'cost',
													  'id'   => 'cost',
													  'size' => 50,
								...
								foreach($records as $row){
								 ...
								 ?>
									<tr>
										...
										<td><center><?php echo $row['materialId']; ?></center></td>
