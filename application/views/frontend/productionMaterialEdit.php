...
<script>
    ...
    //* validation
    $('#productionMaterialEdit').validate({
     onkeyup: false,
     errorClass: 'error',
     validClass: 'valid',
     rules: {
...
<?php 
     ...
     ?>
     <?php
			$attributes = array('name' => 'productionMaterialEdit', 'id' => 'productionMaterialEdit');	   
	  		echo form_open('production/materialEdit' , $attributes);
