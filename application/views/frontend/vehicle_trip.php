...
to: { required:true, },
      ...
      place_from:{required: true},
      place_to:{required: true},
...
<?php 
     ...
     <?php
			...
			$attributes = array('name' => 'vehicletrip', 'id' => 'vehicletrip');	   
	  		echo form_open('vehicletrip/addVehicletrip' , $attributes);
...
?>
<option value="<?php echo $row->id; ?>"><?php echo $row->first_name; echo'&nbsp'; echo $row->last_name; ?></option>
<?php
}
...
?>
<option value="<?php echo $row->from_place; ?>"><?php echo $row->from_place; ?></option>
<?php
}
...
?>
<option value="<?php echo $row->to_place; ?>"><?php echo $row->to_place; ?></option>
<?php
}
