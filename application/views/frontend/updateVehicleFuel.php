...
<script>
     ...
     errorPlacement: function(error, element) {
      $(element).closest('div').append(error);
		...
		var vehicleid = $('#vehicle_id').val();
		   console.log(vehicleid);
                    ...
                    $.ajax({   
                        ...
                        url: "<?php echo base_url(); ?>ajax/vehicleShow/"+vehicleid,
                        async: false,
                        type: "GET",
                        dataType: "html", 
	   ...
	   <script type="text/javascript">
            $(document).ready(function () {
		var vehicleid = $('#diesel_vendor').val();
		   console.log(vehicleid);
			$.ajax({   
		  	url: "<?php echo base_url(); ?>ajax/vendorName/"+vehicleid,
                        async: false,
                        type: "GET",
                        dataType: "html",
                        success: function(data) {
...
<?php 
     ...
     <?php   	
			$attributes = array('name' => 'vehicleFuel', 'id' => 'vehicleFuel');	   
	  		echo form_open('vehicleFuel/edit_vehicleFuel' , $attributes);
...
?>
<option value="<?php echo $row->id; ?>"<?php if($row->id == $fid['value']){ ?> selected <?php }?>><?php echo $row->vendor_name; ?></option>
<?php
}
}
 ?>
