...
<?php 
     ...
     <?php
			$attributes = array('name' => 'materialmaster', 'id' => 'materialmaster');	   
	  		echo form_open('production/productionInEdit' , $attributes);
      ...
      <table class="table table-bordered table-striped" id="smpl_tbl" style="border:none">
		...
		<?php $a=count($plants); 
         ...
         <option value="<?php echo $row['id']; ?>"<?php if($row['id'] == $fplantId['value']){ ?> selected <?php }?>><?php echo $row['plantName']; ?></option>
         <?php }}?></select></div></td>
